...
The goal of the project was to build a recognition system using deep learning that would be able to identify the type of hand motion (shaking, circle, up-down, down-up) that an individual was doing while holding a smartphone as a sensor.  This project was done as part of my exchange program at Tokyo University of Agriculture and Technology in Summer 2018 over the course of 6 weeks.  During my stay, I had the opportunity to work under Professor Tanaka in his laboratory along with one of his student on this project.
